...
def main(args):
    ...
    seq_len = 128
    train_data, test_data = get_wikitext2(seq_len, None)
    train_data = split_and_tokenizer(train_data, tokenizer, seq_len, field_name="text")
    test_data = split_and_tokenizer(test_data, tokenizer, seq_len, field_name='text')
    val_data = {
        "wikitext2": test_data 
    }
...
if __name__ == "__main__":
    ...
    # Model Type&Path
    parser.add_argument('--model', type=str, default="decapoda-research/llama-7b-hf", help='base model name')
