...
def load_model():
  ...
  # )
	...
	tuned_path = "tune_log/llama3.2-intruct/"
	pruned_model = "prune_log/llama3_prune/pytorch_model.bin"
	pruned_dict = torch.load(pruned_model, map_location='cpu', weights_only=False)
